...
var (
	...
	osArchTypeMap = map[OsType][]ArchType{
		Linux:       []ArchType{Arm, Arm64, X86, X86_64},
...
func decodeTargetProductVariables(config *config) (map[OsClass][]Target, error) {
	...
	addTarget(BuildOs, *variables.HostArch, variables.DeviceArchVariant, variables.DeviceCpuVariant, variables.DeviceAbi)
	...
	if variables.DeviceArch != nil && *variables.DeviceArch != "" {
		addTarget(Android, *variables.DeviceArch, variables.DeviceArchVariant, variables.DeviceCpuVariant, variables.DeviceAbi)
