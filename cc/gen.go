...
func init() {
	pctx.StaticVariable("lexCmd", android.TermuxExecutable("flex"))
	pctx.StaticVariable("yaccCmd", android.TermuxExecutable("bison"))
	pctx.StaticVariable("yaccDataDir", filepath.Join(android.Prefix(), "share/bison"))
